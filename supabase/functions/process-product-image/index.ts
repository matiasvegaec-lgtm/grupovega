  ...
  try {
    ...
    const promptText =
      bgMode === "white"
        ...
        : "Remove the original background completely and replace it with a perfectly SOLID PURE GREEN background (exact color #00FF00, RGB 0,255,0 — a flat chroma-key green, no gradient, no shadow, no texture, no checkerboard pattern, no transparency indicator). Keep ONLY the product, perfectly cut out with clean smooth edges (no green halo or fringe on the product). Center the product in a square 1:1 composition with about 8% padding on all sides. Preserve the product intact, sharp and well lit, with its original colors untouched. Do not add any text, logos, decorations, watermarks, borders or extra objects. The product itself must NOT contain the color #00FF00. Output a PNG where every pixel outside the product is exactly #00FF00.";
