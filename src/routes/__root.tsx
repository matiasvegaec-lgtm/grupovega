...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Grupo Vega: Soluciones integrales para la industria acuícola. Ofrecemos insumos de alta calidad, nutrición especializada y suministros técnicos para optimizar tu producción de camarón en Ecuador." },
      { name: "author", content: "Grupo Vega" },
      { property: "og:title", content: "Grupo Vega | Nutrición y Suministros Acuícolas" },
      { property: "og:description", content: "Grupo Vega: Soluciones integrales para la industria acuícola. Ofrecemos insumos de alta calidad, nutrición especializada y suministros técnicos para optimizar tu producción de camarón en Ecuador." },
      ...
      { name: "twitter:description", content: "Grupo Vega: Soluciones integrales para la industria acuícola. Ofrecemos insumos de alta calidad, nutrición especializada y suministros técnicos para optimizar tu producción de camarón en Ecuador." },
